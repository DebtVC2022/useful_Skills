    ...
    return {
        "weights": {
            "resume_quality": {
                ...
                "experience_credibility": 10,
                "achievement_impact": 15,
                "capability_clarity": 10,
                "risk_review_signals": 5,
            },
            "jd_company_match": {
                "hard_requirement_match": 10,
                "core_capability_match": 12,
                "domain_industry_relevance": 6,
                "seniority_match": 6,
                "company_team_preference_match": 4,
                "interview_validation_value": 2,
            },
        }
    }
...
def weighted_result():
    ...
    result["scores"]["dimensions"] = [
        ...
        },
        {
            ...
            "score": 12,
            "max_score": 15,
            "evidence": ["Impact metrics are visible."],
            "deductions": [],
        },
        {
            ...
            "score": 9,
            "max_score": 10,
            "evidence": ["Responsibilities are concrete."],
            "deductions": [],
        },
        {
        ...
        {
            "name": "company_team_preference_match",
            "score": 3,
            "max_score": 4,
            "evidence": ["Company preference evidence is visible."],
            "deductions": [],
        },
        {
...
def test_configured_weight_dimensions_reject_sum_mismatch():
    result = weighted_result()
    result["scores"]["dimensions"][0]["score"] = 7
