...
New-Item -ItemType Directory -Force -Path (Join-Path $ProjectFull "specs") | Out-Null
New-Item -ItemType Directory -Force -Path (Join-Path $ProjectFull "changes\archive") | Out-Null
...
if ($Target -eq "codex" -or $Target -eq "all") {
  ...
  New-Item -ItemType Directory -Force -Path (Join-Path $CodexHome "skills\demandspec") | Out-Null
  Copy-Item (Join-Path $KitRoot "commands\codex\*.md") (Join-Path $CodexHome "prompts") -Force
  Copy-Item (Join-Path $KitRoot "skills\demandspec\*") (Join-Path $CodexHome "skills\demandspec") -Recurse -Force
  ...
  Write-Host "Installed Codex skill to $CodexHome\skills\demandspec"
}
